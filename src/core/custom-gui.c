...
if (!sd_mount()){BootStrapNX();}//check sd
    ...
    memcpy(header + 34, &imagesize, 4);
		if (!sd_file_exists("NEXT/screenshot-1.bmp")){namef = "-1";
			}else{
			if (!sd_file_exists("NEXT/screenshot-2.bmp")){namef = "-2";
				}else{
				if (!sd_file_exists("NEXT/screenshot-3.bmp")){namef = "-3";
					}else{
					if (!sd_file_exists("NEXT/screenshot-4.bmp")){namef = "-4";
						}else{
						if (!sd_file_exists("NEXT/screenshot-5.bmp")){namef = "-5";
							}else{
							if (!sd_file_exists("NEXT/screenshot-6.bmp")){namef = "-6";
								}else{
								if (!sd_file_exists("NEXT/screenshot-7.bmp")){namef = "-7";
    ...
    g_gfx_con.scale = 2;
    gfx_con_setpos(&g_gfx_con, 0, 555);
