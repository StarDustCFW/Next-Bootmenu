...
/*
    ...
    sd_save_to_file(buffer, 1, "NEXT/boot.txt");
*/
    if(boot==1)
    {
		...
		sd_save_to_file("Atmosphere", 10, "NEXT/autobootecho.txt");
    }
    ...
    if(boot==2)
    {
		...
		if (sd_file_exists ("NEXT/autobootecho.txt"))
		sd_save_to_file("ReiNX", 5, "NEXT/autobootecho.txt");
    }

	if(boot==3)
    {
		if (sd_file_exists ("NEXT/autobootecho.txt"))
		sd_save_to_file("SXOS", 4, "NEXT/autobootecho.txt");
	}
